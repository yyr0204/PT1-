...
<script>
	alert("관리자만 글쓰기 가능");
	location = "/pt1/admin/loginForm.jsp";
</script>
<%
}
%>
...
<body>
	<h2>글쓰기</h2>
	<br>
	<form method="post" name="boardinput" action="noticeWritePro.jsp"
		onSubmit="return checkIt()">
		<input type="hidden" name="num" value="<%=num%>">
		<input type="hidden" name="category" value="notice">
		<table border="1">
			<tr>
				<td><a href="noticeMain.jsp"> 글목록</a></td>
			</tr>
			<tr>
				<td>제 목</td>
			...
			<tr>
				<td colspan="2"><input type="submit" value="글쓰기"> <input
					...
					value="목록보기" OnClick="window.location='noticeMain.jsp'"></td>
			</tr>
		</table>
		<%
		} catch (Exception e) {
