...
<body>
   ...
   <%
   //조회 결과 출력
      if (request.getAttribute("salesProductList") != null) {
         List<Map<String, Object>> salesProductList = (List<Map<String, Object>>) request.getAttribute("salesProductList");
         if (salesProductList.size() == 0) {%>
   ...
   <%
         for (Map<String, Object> productSales : salesProductList) {
   %>
   <tr>
