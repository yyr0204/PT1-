...
<body>
	...
	<h2><%=store_id%> 일별 매출</h2>
	<h2><a href="salesStore.jsp">점주별 매출로 돌아가기</a></h2>
	<!-- 기간 입력 -->
	<div>
		<form method="get" action="salesStoreDailyPro.jsp">
			...
			<input type="hidden" name="stoId" value="<%=store_id %>">
